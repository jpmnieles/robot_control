"""Script for Aligning Chessboard to the Eye Camera of Grace
"""
...
class GraceAlign(object):
    ...
    def process_img(self, img, mtx, dist):
...
if __name__ == "__main__":
    ...
    while(1):
        try:
            ...
            l_img = alignment.process_img(l_img, l_mtx, l_dist)
        ...
        try:
            ...
            r_img = alignment.process_img(r_img, r_mtx, r_dist)
