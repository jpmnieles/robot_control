...
images = glob.glob(os.path.join(os.path.realpath(__file__), '..\..', 'results/230529_right/*.png'))
...
print(mtx)
print(dist)
np.savez(os.path.join(os.path.abspath(""), "results","230529_right", "camera_mtx.npz"), mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)  # Saving parameters
...
img = cv.imread(os.path.join(os.path.abspath(""), "results","230529_right", "20230529_223506_436435_right_eye.png"))
h,  w = img.shape[:2]
